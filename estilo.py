...
def carregar_estilo_login():
    st.markdown("""
    <style>
        /* Esconde elementos padrão do Streamlit na página de login */
        ...
        /* Remove paddings e margens do bloco principal do Streamlit */
        ...
        /* Oculta barras de rolagem nativas da página */
        [data-testid="stAppViewContainer"] {
            overflow: hidden !important;
        }

        /* Força o iframe do componente de login a ser fixado em tela cheia */
        iframe[title*="login_comp"] {
